...
describe('FormGroup', () => {
  ...
  it('should hasErrorAndTouched', () => {
    const control = createGroup();
    expect(control.hasErrorAndTouched('isValid')).toBeFalsy();
    control.markAsTouched();
    expect(control.hasErrorAndTouched('isValid')).toBeTruthy();
  });

  it('should hasErrorAndDirty', () => {
    const control = createGroup(true);
    expect(control.hasErrorAndDirty('isValid')).toBeFalsy();
    control.markAsDirty();
    expect(control.hasErrorAndDirty('isValid')).toBeTruthy();
  });
